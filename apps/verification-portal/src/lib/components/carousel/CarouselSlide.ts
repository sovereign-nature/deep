// https://github.com/themesberg/flowbite-svelte/blob/main/src/lib/carousel/CarouselSlide.ts
...
export const canChangeSlide = ({
  ...
  if (
    lastSlideChange &&
    new Date().getTime() - lastSlideChange.getTime() <
      slideDuration * slideDurationRatio
  ) {
