<div
  class="flex flex-wrap md:flex-nowrap lg:flex-col xl:flex-row items-center justify-center xl:items-end gap-3"
>
  ...
  <div class="text-center">
    <span class="bg-white h-24 w-24 rounded-full block m-4"></span>
    <span class="text-sm xl:text-black">By all copies</span>
  </div>
  <div class="text-center">
