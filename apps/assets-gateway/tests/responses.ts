export const WHALE_ASSET = {
  id: '13-738',
  tokenId: '738',
  name: 'Epic Dolphin',
  description: '',
  image: 'ipfs://QmcQG5c8qnhBnUjDGggoVput5Fjz7N4PaM7eTSMvsBwUJj',
  collection: {
    id: '13',
    name: 'The sub0 2023 Biodiversity Collection',
  },
};

export const HH_ASSET = {
  ...
  tokenId: 'upemba-national-park-curls',
};
